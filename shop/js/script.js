...
function playVideos() {
	var playlist = _.map(vidsJSON.vids, function(videoJSON) {
		var playlistEntryJSON = {containment:'body',autoPlay:true, mute:true, volume:1, opacity:1, ratio:'4/3', loop:true, showControls:false, showYTLogo:false, stopMovieOnBlur:false};
